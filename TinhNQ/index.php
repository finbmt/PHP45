<?php
	...
	$sql_dacsac = "select * from tbl_DMHang order by MaHang DESC limit 6";
	$list_dacsac = select_array($sql_dacsac);

	$sql_loaihang_aothun = "select * from tbl_DMHang where MaLoaiHang='8' order by MaHang DESC limit 4";
	$list_loaihang_aothun = select_array($sql_loaihang_aothun);
?>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Sản phẩm đặc sắc</h2>
						<?php
						foreach ($list_dacsac as $item) {
						?>
						<div class="col-sm-4">
					...
					<div class="category-tab"><!--category-tab-->
						...
						<div class="tab-content">
							<div class="tab-pane fade active in" id="tshirt" >
								<?php
								foreach ($list_loaihang_aothun as $item) {
								?>
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
